...
const articuloRegMod = new ArticuloRegular('Articulo MOD', 'archivo 1', 'resumen 1');
const articulReg2 = new ArticuloRegular('Articulo 2', 'archivo 2', 'resumen 2');
const articulPos1 = new ArticuloPoster('Articulo Poster 1', 'archivo 1', 'fuente 1');
...
autor3.asignarArticulo(articulReg2)
autor3.asignarArticulo(articulPos1)

// Recepción de artículos
console.log('Estado sesion:', sesion1.estado);
autor1.enviarArticulo(articuloReg1, sesion1);
autor1.enviarArticulo(articulReg2, sesion1);
autor3.enviarArticulo(articulPos1, sesion1);
autor1.modificarArticulo(articuloReg1, articuloRegMod, sesion1)
console.log('Estado sesion:', sesion1.articulos);
